...
{
    // Pass in light data
    public class ComponentShaderBillboard : ComponentShader
    {
        ...
        public ComponentShaderBillboard(string pVertexPath, string pFragmentPath) : base(pVertexPath, pFragmentPath)
        {
